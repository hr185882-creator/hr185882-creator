...
I build systems that help people and organizations make better decisions when the information is messy, incomplete, or contested.

My work focuses on three things:
- Checking whether information is reliable
- Turning large amounts of data into clear, usable records
- Supporting careful forecasting and decision-making
...
- Test the strongest opposing view before deciding
- Keep a clear record of what was known, assumed, and changed
- Final judgment stays with humans

---

## Who This Is For

- Companies and researchers who need reliable analysis under uncertainty
- Teams building or evaluating AI systems
- Organizations that want clear, source-linked records instead of opaque reports
- Recruiters and hiring managers looking for someone who ships real systems, not just slides
...
- Open to remote contract and full-time roles in AI evaluation, research systems, intelligence analysis, and decision-support product work
